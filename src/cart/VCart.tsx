...
import { VPage, Page, Form, ObjectSchema, NumSchema, ArrSchema, UiSchema, UiArr, FormField, UiItem, ChangedHandler, UiCustom } from 'tonva';
...
export class VCart extends VPage<CCart> {
    ...
    private uiQuantityItem: UiCustom = {
        widget: 'custom',
        className: 'text-center',
        WidgetClass: MinusPlusWidget,
        onChanged: this.controller.onQuantityChanged as ChangedHandler
    };
